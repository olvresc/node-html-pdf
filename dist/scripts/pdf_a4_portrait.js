...
// -----------------------------
if (options.httpCookies)
    page.cookies = options.httpCookies;
    ...
    return {
        ...
        contents: phantom.callback(function (pageNum, numPages) {
            ...
            if (pageNumFinal === 1 && !html)
                html = o.first || c.first;
            if (pageNumFinal === numPages && !html)
                html = o.last || c.last;
            return ((html || o.default || c.default || '').replace(/{{page}}/g, pageNumFinal).replace(/{{pages}}/g, numPagesFinal) +
                content.styles);
        }),
    };
}
